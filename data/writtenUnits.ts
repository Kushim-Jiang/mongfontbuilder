...
export const writtenUnits = {
  ...
  Hh: {
    init: { code: 0xe0b5, pre_a: 0xe26a },
    medi: { code: 0xe0b6 },
  },
  Hh2: {
    medi: { code: 0xe139, pre_a: 0xe26b },
  },
  Hp: {
    medi: { code: 0xe078 },
    fina: { code: 0xe079 },
  ...
  Hy: {
    init: { code: 0xe110, pre_a: 0xe26c },
    medi: { code: 0xe111 },
  },
  Hy2: {
    medi: { code: 0xe112, pre_a: 0xe26d },
  },
  I: {
    isol: { code: 0xe007 },
    init: { code: 0xe008 },
  ...
  W: {
    init: { code: 0xe049 },
    medi: { code: 0xe04a, post_b: 0xe04a },
    fina: { code: 0xe04b, post_b: 0xe04b },
  },
  Wb: {
    init: { code: 0xe097 },
    medi: { code: 0xe098 },
...
export const punctuation = {
  Boundaryleft: { code: 0xe300 },
  Boundaryright: { code: 0xe301 },
  Birga: { unicode: 0x1800, code: 0xe302 },
  Birga1a: { unicode: 0x11660, code: 0xe317 },
  Birga1b: { unicode: 0x11664, code: 0xe31b },
  Birga1c: { unicode: 0x11662, code: 0xe319 },
  Birga1d: { unicode: 0x11663, code: 0xe31a },
  Birga2a: { unicode: 0x11661, code: 0xe318 },
  Birga2b: { unicode: 0x11665, code: 0xe31c },
  Birga2c: { unicode: 0x11666, code: 0xe31d },
  Birga3a: { unicode: 0x11667, code: 0xe31e },
  Birga3b: { unicode: 0x11668, code: 0xe31f },
  Birga4a: { unicode: 0x11669, code: 0xe320 },
  Birga4b: { unicode: 0x1166a, code: 0xe321 },
  Birga4c: { unicode: 0x1166b, code: 0xe322 },
  Birga4d: { unicode: 0x1166c, code: 0xe323 },
  Hudumellipsis: { unicode: 0x1801, code: 0xe303 },
  Hudumcomma: { unicode: 0x1802, code: 0xe304, space: true },
  Hudumfullstop: { unicode: 0x1803, code: 0xe305, space: true },
  Hudumcolon: { unicode: 0x1804, code: 0xe306, space: true },
  Hudumfourdots: { unicode: 0x1805, code: 0xe307, space: true },
  Todolinefiller: { unicode: 0x1806, code: 0xe324 },
  Manchucomma: { unicode: 0x1808, code: 0xe32d, space: true },
  Manchufullstop: { unicode: 0x1809, code: 0xe32e, space: true },
  Chinamiddledot: { unicode: 0x00b7, code: 0xe308 },
  Chinaquestionexclamation: { unicode: 0x2048, code: 0xe309, space: true },
  Chinaexclamationquestion: { unicode: 0x2049, code: 0xe30a, space: true },
  Chinasemicolon: { unicode: 0xff1b, code: 0xe30b, space: true },
  Chinaexclamation: { unicode: 0xff01, code: 0xe30c, space: true },
  Chinaquestion: { unicode: 0xff1f, code: 0xe30d, space: true },
  Chinaemdash: { unicode: 0x2014, code: 0xe30e },
  Chinaellipsis: { unicode: 0x2026, code: 0xe325 },
  Chinacomma: { unicode: 0xff0c, code: 0xe32c, space: true },
  Chinacomma2: { unicode: 0x3001, code: 0xe326, space: true },
  Chinafullstop: { unicode: 0x3002, code: 0xe327, space: true },
  Chinacolon: { unicode: 0xff1a, code: 0xe32f, space: true },
  Chinaquotationleftsingle: { unicode: 0x2018, code: 0xe330 },
  Chinaquotationrightsingle: { unicode: 0x2019, code: 0xe331 },
  Chinaquotationleftdouble: { unicode: 0x201c, code: 0xe332 },
  Chinaquotationrightdouble: { unicode: 0x201d, code: 0xe333 },
  Chinabraketleftround: { unicode: 0xff08, code: 0xe30f },
  Chinabraketrightround: { unicode: 0xff09, code: 0xe310 },
  Chinabracketleftdoubleangle: { unicode: 0x300a, code: 0xe311 },
  Chinabracketrightdoubleangle: { unicode: 0x300b, code: 0xe312 },
  Chinabracketleftangle: { unicode: 0x3008, code: 0xe313 },
  Chinabracketrightangle: { unicode: 0x3009, code: 0xe314 },
  Chinabracketleftsquare: { unicode: 0xff3b, code: 0xe315 },
  Chinabracketrightsquare: { unicode: 0xff3d, code: 0xe316 },
  Chinabracketleftcorner: { unicode: 0x300c, code: 0xe328 },
  Chinabracketrightcorner: { unicode: 0x300d, code: 0xe329 },
  Chinabracketleftwhitecorner: { unicode: 0x300e, code: 0xe32a },
  Chinabracketrightwhitecorner: { unicode: 0x300f, code: 0xe32b },
} as const;
