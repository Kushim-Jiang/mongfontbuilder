...
from tptq.feacomposer import AnyGlyph, ContextualInput, FeaComposer, NormalizedAnyGlyph
            ...
            with c.Lookup(
                ...
                if "MNG" in self.locales:
                    vowelVariants = c.namedGlyphClass(
                        ...
                        c.writtens("MNG", lambda x: x[-1] != "I", (init, medi), ct["vowel"]).glyphs,
                    )
