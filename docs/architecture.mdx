...
| Index | Shaping phase           | Shaping step                            |
| :---- | :---------------------- | :-------------------------------------- |
| Ia.1  | Ia. General             | Basic character-to-glyph mapping        |
| IIa.1 | IIa. Cursive script     | Initiation of cursive positions         |
| III.1 | III. Mongolian-specific | Phonetic: Chachlag                      |
| III.2 | III. Mongolian-specific | Phonetic: Syllabic                      |
| III.3 | III. Mongolian-specific | Phonetic: Particle                      |
| III.4 | III. Mongolian-specific | Graphemic: Devsger                      |
| III.5 | III. Mongolian-specific | Graphemic: Post-bowed                   |
| III.6 | III. Mongolian-specific | Uncaptured: FVS-selected                |
| IIb.1 | IIb. Cursive script     | Variation involving bowed written units |
| IIb.2 | IIb. Cursive script     | Cleanup of format controls              |
| IIb.3 | IIb. Cursive script     | Optional treatments                     |
| Ib.1  | Ib. General             | Vertical forms of punctuation marks     |
| Ib.2  | Ib. General             | Optional treatments                     |
